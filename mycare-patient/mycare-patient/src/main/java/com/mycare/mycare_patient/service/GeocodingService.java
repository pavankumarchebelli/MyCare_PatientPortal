package com.mycare.mycare_patient.service;
...
public class GeocodingService {
    ...
    public double[] getLatLongFromAddress(String street, String county, String state, String zipcode) {
        String fullAddress = String.format("%s, %s, %s %s", street, county, state, zipcode);
